...
//______________________________________________________________________________
nEXOTRefArray& nEXOTRefArray::operator=(const nEXOTRefArray& a)
{
...
//______________________________________________________________________________
TObject *nEXOTRefArray::operator[](Int_t at) const
{
  return At(at);
}

//______________________________________________________________________________
TObject *nEXOTRefArray::At(Int_t at) const
{
...
//______________________________________________________________________________
TObject *nEXOTRefArray::AtWithoutTable(Int_t at) const
{
   // Return the object at position i. Returns 0 if i is out of bounds.
...
//______________________________________________________________________________
//void nEXOTRefArray::Streamer(TBuffer &R__b)
//{
